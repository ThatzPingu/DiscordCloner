...
class Copy(object):
    ...
    def create_roles(self):
        ...
        for role in roles:
            ...
            if new_role.get("code"):
                print(f"\033Missing Permissions {role['name']}\033")
                continue
            print(f"\33 Create role {role['name']}\033")
    ...
    def create_channels(self):
        ...
        for channel in free_channels:
            ...
            if o.get("code"):
                print(f"\033Missing Permissions {channel['name']}\033")
                continue
            print(f"\33 Create channel {channel['name']}\033")
        for category in categorys:
            ...
            if new_category.get("code"):
                print(f"\033Missing Permissions {category['name']}\033")
                continue
            print(f"\33 Create category {category['name']}\033")
    ...
    def create_emojis(self):
        ...
        for emoji in emojis:
            ...
            if o.get("code"):
                print(f"\033Missing Permissions {emoji['name']}\033")
                continue
            print(f"\33 Create emoji {emoji['name']}\033")
